...
<html>
  <head>
    ...
    <title>My JSP 'Finish_Order.jsp' starting page</title>
...
$(function(){
	$('#review').datagrid({
		...
		columns:[[
			...
			{field:'sendaddress',title:'发件地址',width:80},
			{field:'recvname',title:'收件人姓名',width:80},
			{field:'recvphone',title:'收件人电话',width:80},
			{field:'recvaddress',title:'收件地址',width:80},
	...
	function query(){
		...
		url ='<%=basePath%>siteBack/queryOrderOnSite.do?&pointid='+pointId+'&state='+state+'&flag=end';
